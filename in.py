...
bot = telebot.TeleBot('7561369479:AAEntup3rNOUeHvUMXbHBU1wkdqa7W5Ywd0')

# Admin user IDs
admin_id = ["5439373820", "7858368373"]
...
def add_user(message):
    ...
    if user_id in admin_id:
        ...
        response = "You have not purchased yet purchase now from:-@kaira2op."
...
@bot.message_handler(func=lambda msg: msg.text.lower().startswith("kaira"))
def handle_arman(message):
    ...
    if user_id in allowed_user_ids:
        ...
        if len(command) == 4:  
            ...
            response = "Usage: kaira <target> <port> <time>\n\nEXAMPLE :- kaira 20.284.34.34 10376 120" 
            bot.reply_to(message, response)
    else:
        response = "Unauthorized Access! \n\nDM to buy access: @kaira2op"
        bot.reply_to(message, response)
...
"""
    ...
    contact_button = InlineKeyboardButton("📞 Contact Owner", url="https://t.me/kaira2op")
...
💡 **Stay smart and enjoy our services!**  
   Contact us if you have any questions: [Contact Owner](https://t.me/kaira2op)
"""
